...
class WindowB(QWidget):
    ...
    def add_buttons(self):
        ...
        self.button52.setIcon(QIcon("./images/closemenu.png"))
        ...
        self.button53.setIcon(QIcon("./images/closemenu.png"))
        ...
        self.button54.setIcon(QIcon("./images/closemenu.png"))
        ...
        self.button55.setIcon(QIcon("./images/closemenu.png"))
        ...
        self.button91.setIcon(QIcon("./images/screenshot.png"))
        ...
        self.button92.setIcon(QIcon("./images/screenshot.png"))

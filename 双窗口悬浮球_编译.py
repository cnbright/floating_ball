...
class WindowB(QWidget):
    ...
    def add_buttons(self):
        ...
        self.button2.setIcon(QIcon(os.path.join(data_dir, 'taskmgr.png')))
        ...
        self.button4.setIcon(QIcon(os.path.join(data_dir, 'voldown.png')))
        ...
        self.button6.setIcon(QIcon(os.path.join(data_dir, 'volup.png')))
